...
Model description
======================================
This model is based on the quantization of simple transformer models, only with 10000 data points. 
we will be increasing it to full dataset.
It was keep crashing as we did see on the Jupyter notebook.
...
data_dir = "../../../MLPF/mlpf/tensorflow_datasets/"
...
for ind in inds_train:
    ...
    loss_vals.append({k: v.detach().cpu().item() for k, v in loss.items()})
    optimizer.step()
...
plt.xlabel("true MET")
plt.ylabel("pred MET")
plt.savefig("/afs/cern.ch/user/s/sraj/sraj/www/CUA/mlpf-quantization/plots/MET_comparison.png")
plt.savefig("/afs/cern.ch/user/s/sraj/sraj/www/CUA/mlpf-quantization/plots/MET_comparison.pdf")
